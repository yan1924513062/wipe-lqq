...
Swipe.prototype.addEvent=function(){
	...
	this.device = (/android|webos|iPhone|ipad|ipod|blackberry|iemobile|operamini/i.test(navigator.userAgent.toLowerCase()));
	...
	this.cas.addEventListener(that.endEvent,function(evt){
